...
def main() -> None:
    ...
    parser.add_argument("--case-attempts", type=int, default=1)
...
def _is_retryable_eval_error(exc: Exception) -> bool:
    # The vision client owns the only retry loop. Whole-case retries would repeat
    # an already exhausted image-analysis operation.
    return False
